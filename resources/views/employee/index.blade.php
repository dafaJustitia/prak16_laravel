    ...
    <script type="module">
        $(document).ready(function() {
            ...
            $("#employeeTable").DataTable({
                serverSide: true,
                processing: true,
                ajax: "/getEmployees", // Replace with the appropriate route for fetching employee data
                columns: [
            ...
            $(".datatable").on("click", ".btn-delete", function (e) {
                ...
                var name = $(this).data("name"); // Get the employee name from the data attribute
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        form.submit(); // Submit form if the user confirms
                    }
                });
            });
        });
